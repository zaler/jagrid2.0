...
export default function InstagramPortrait() {

    const renderItems = () => {
        return files.map((file, index) => {
            return (
                <Carousel.Item key={index}>
                    <div style={{ backgroundPosition: "center", backgroundSize: "100%", backgroundRepeat: "no-repeat", backgroundImage: `url(/storage/${file.path})` }}>
                        <img
                            className="d-block w-100 invisible"
                            src="/storage/events/mockups/1080x1350.png"
                            alt=""
                        />
                    </div>
                </Carousel.Item>
    ...
    return (
        <div className="instagram-feed-portrait" style={{ maxWidth: "420px" }}>
