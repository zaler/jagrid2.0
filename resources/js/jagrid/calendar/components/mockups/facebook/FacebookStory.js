...
export default function FacebookStory({ files }) {

    const renderItems = () => {
        return files.map((file, index) => {
            return (
                <Carousel.Item key={index}>
                    <div className="facebook-story-editable" style={{ backgroundPosition: "center", backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundImage: `url(/storage/${file.path})` }}>
                        <img
        ...
        <div className="instagram-story position-relative mx-auto" style={{ maxWidth: "420px" }}>
            <div className="instagram-story-shadow-top">
                <div className="row align-items-center justify-content-between">
                    <div className="col-10">
                        ...
                        &nbsp;
                        <small className="instagram-brand-top text-white">{account_name}</small> &nbsp; <time
                            className="text-white instagram-time-story">21 h</time>
                    </div>
            ...
            <div className="bottom-controls">
                ...
                <div className="facebook-emojis">
                    <img src="/storage/events/mockups/emojis/like.svg" width="28" />&nbsp;
                    <img src="/storage/events/mockups/emojis/heart.svg" width="28" />&nbsp;
                    <img src="/storage/events/mockups/emojis/emoji.svg" width="28" />
                </div>
            </div>
            <Carousel>
                {renderItems()}
