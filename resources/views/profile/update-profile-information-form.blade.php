<x-jet-form-section submit="updateProfileInformation">
  ...
  <x-slot name="description">
    {{ __('locale.Update your account profile information and email address') }}
  </x-slot>
  ...
  <x-slot name="form">
    ...
    <!-- Name -->
    <div class="mb-1">
      <x-jet-label class="form-label" for="name" value="{{ __('locale.Name') }}" />
    ...
    <!-- Email -->
    <div class="mb-1">
      <x-jet-label class="form-label" for="email" value="{{ __('locale.Email') }}" />
