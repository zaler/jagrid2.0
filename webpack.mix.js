...
mix.js('resources/js/jagrid/calendar/App.js', 'public/js/calendar.js')
    .react().version()

mix.js('resources/js/jagrid/cards/App.js', 'public/js/cards.js')
    .react().version()

mix.js('resources/js/jagrid/feedbacks/App.js', 'public/js/feedbacks.js')
    .react().version()

mix.js('resources/js/jagrid/timer/App.js', 'public/js/timer.js').react().version()

mix.js('resources/js/jagrid/mockups/Mockups.js', 'public/js/mockups.js')
    .react().version()