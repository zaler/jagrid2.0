            ...
            <div className="mx-auto">
                ...
                <div className="row">
                    <div className="col-12 position-relative">
                        <Carousel>
                            <Carousel.Item>
                                <div className="instagram-square-editable" style={{ backgroundSize: "100%", backgroundRepeat: "no-repeat", backgroundImage: `url(https://jagrid.io/storage/events/final/K7G8tYU0nGgAa345uf2WRczv9zw40ziuSvWD3s5z.jpg)` }}>
                                    <img
