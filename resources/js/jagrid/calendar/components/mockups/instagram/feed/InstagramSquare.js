...
export default function InstagramSquare({ files }) {

    const renderItems = () => {
        return files.map((file, index) => {
            return (
                <Carousel.Item key={index}>
                    <div className="instagram-square-editable" style={{ backgroundPosition: "center", backgroundSize: "100%", backgroundRepeat: "no-repeat", backgroundImage: `url(/storage/${file.path})` }}>
                        <img
